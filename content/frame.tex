...
\subsubsection{Központi vezérlő}
...
és a feldolgozást a szerver oldalon központosítja, ami növeli a robusztusságot.
...
Ezért el kell tolnunk az értékeket ehhez kell két ellenállás, amelyek feszültségosztót alkotnak 
...
viszont a nodeMCU környezet már végez az áramkörön feszültség átalakítást így a bemeneti skála változik 0 és 3,3 voltra.
...
teljesítményt el tud disszipálni folyamatos terhelés melett is.
...
HTTPS-el. Az ESP8266 támogatja a TLS protokollt.

\subsection{Energetikai eszköz és helyi vezérlő között}
...
Eredetileg PLC-k közötti Kommunikáció kialakítására használták.
...
töltőkről, és regisztereket írni. Ezzel át tudtam írni a töltőben a maximális áramértéket amit engedélyezett. 
...
Ez a gyakorlatban ez azt jelenti, hogy TCP keretekbe foglalja a már előbb felsorolt kommunikációt.
