...
ami Get kérések küld a lokális vezérlőknek. 
...
\section{Max--min fair (water-filling) elosztás}
...
A rendszerben két védelem stalálható:
...
\subsubsection{Definíció (max--min fair)}
...
\subsubsection{Feltöltés (water-filling)}
...
\subsection{Bevezetés: A reakcióidő kritikus szerepe}
