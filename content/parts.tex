...
A Kontroll Szerver a keretrendszer központi döntéshozó egysége.
...
Azért,erre esett a választásom, mert
...
\begin{lstlisting}[language=Python, caption={Prometheus metrika deklarálása a Flask szerveren}]
...
Ennek kiküszöbölésére a Kontroll Szervert egy dinamikus aggregációs rétegként alkalmazom.
A Prometheus konfigurációjában így egyetlen stabil, statikus célpont szerepel:
maga a Kontroll Szerver.
