...
A teszt során a Kontroll Szerver \texttt{Deployment}-je 2 replikával fut. 
...
\begin{enumerate}
    ...
    szándékosan lelövöm az aktív vezérlő konténert, szimulálva egy szoftveres összeomlást.
